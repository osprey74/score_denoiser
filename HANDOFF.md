...
### 未実装（Phase 2.5 候補）
- [x] **分割モードのビューポート同期** — view 状態を App.tsx に lift し両 canvas で共有（2026-05-17）
- [x] **Blur / Close をスライダー化** + パラメータ変更時のズーム保持（2026-05-17）
- [x] **アプリ名を Nitido に確定** + 「このアプリについて」ダイアログ（2026-05-17）
